                ...
                <tbody>
                  {appointments.map((appointment) => (
                    <tr key={appointment.id} className="border-b">
                      ...
                      <td className="py-2 px-4">
                        <span className="flex items-center">
                          <svg class="w-5 h-5 mr-2 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      ...
                      <td className="py-2 px-4">
                        <span className="flex items-center">
                          <svg class="w-5 h-5 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                      ...
                      <td className="py-2 px-4">
                        <span class="bg-gray-100 text-gray-400 text-sm font-medium me-2 px-2.5 py-0.5 rounded">
                          {appointment.injury}
                        </span>
                      </td>
                      <td className="py-2 px-4">
