...
const TableHead = () => {
  return (
    <thead className="text-[#7e7e96] bg-[#F6F6F6] uppercase text-xs font-semibold">
      <tr>
        <th className="text-sm py-6 px-4">Patients</th>
        <th className="text-sm py-6 px-4">Date</th>
        <th className="text-sm py-6 px-4  max-[685px]:hidden table-cell">
          Time
        </th>
        <th className="text-sm py-6 px-4 min-[845px]:table-cell hidden">
          Doctor
        </th>
