            ...
            <div className="main w-full  px-12 py-14  border-2 rounded-lg">
                ...
                <table className=' w-full   '>
                    <thead className=' rounded-lg text-gray-400 bg-gray-100 '  >
                        <tr className='text-left text-[19px] font-[300px] uppercase '>
                            ...
                            <tr key={index} className='border-b hover:bg-slate-50 cursor-pointer  '>
                                <td className='px-4 py-3'>
                                    <div className='flex items-center gap-2 mb-1'>
                                        ...
                                        <span className='text-[17px] text-slate-600 font-bold'>{item.patient_name}</span>
                                    </div>
                                    <span className='text-[16px] font-semibold text-slate-700'>+{item.mobile_number}</span>
                                </td>
                                <td className='px-4 py-2 '>
                                    <div className='flex items-center gap-2 text-slate-500 font-semibold text-[17px]'>
                                        <span><SlCalender  /></span>

                                        <span>{formatDate(item.appointment_date)}</span>
                                    </div>
                                </td>
                                <td className='px-4 py-2'><div className='flex items-center gap-2 text-slate-500 font-semibold text-[17px] '>
                                    <span><IoMdTime /></span>
                                ...
                                <td className='px-4 py-2'> <span className='bg-slate-200 rounded-lg px-3 py-2 font-bold text-[17px] text-slate-500 text-center'>{item.injury} </span></td>
                                <td className='px-4 py-2'>
                                    <span className=' cursor-pointer'><HiOutlineDotsVertical className='hover:scale-150 transition duration-300 ease-in-out text-[17px]'/></span>
                                </td>
                            </tr>
                        ))}
